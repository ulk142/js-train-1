...
function checkDataType(value) {
	...
	return "Виведе: Значення \"" + value + "\" має тип \"" + typeof value + "\".";
}
...
function getVariableType(variable) {
	...
	return (typeof variable == "number") ? "Це число" : ((typeof variable == "string") ? "Це рядок" : ((typeof variable == "boolean") ? "Це булеве значення" : "Це інший тип"));
}
